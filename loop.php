...
<?php if ( $wp_query->max_num_pages > 1 ) : ?>
	<div id="nav-above" class="navigation">
		<div class="nav-previous"><?php next_posts_link( __( '<span class="meta-nav">&larr;</span> Eambbo siiddut', 'twentyten' ) ); ?></div>
		<div class="nav-next"><?php previous_posts_link( __( 'Eambbo siiddut <span class="meta-nav">&rarr;</span>', 'twentyten' ) ); ?></div>
	</div><!-- #nav-above -->
<?php endif; ?>
...
<?php /* How to display posts of the Aside format. The asides category is the old way. */ ?>
	...
	<?php elseif ( ( function_exists( 'get_post_format' ) && 'aside' == get_post_format( $post->ID ) ) || in_category( _x( 'asides', 'asides category slug', 'twentyten' ) )  ) : ?>
		...
		<?php else : ?>
			<div class="entry-content">
				<?php the_content( __( 'Les mer <span class="meta-nav">&rarr;</span>', 'twentyten' ) ); ?>
			</div><!-- .entry-content -->
		<?php endif; ?>
